  ...
  return (
    <div className="relative w-full sm:max-w-xs">
      ...
      <input
        ...
        className="w-full rounded-xl border border-brand-200 py-2.5 pl-9 pr-9 text-sm focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-100"
      />
      {value && (
        <button
          onClick={() => onChange('')}
