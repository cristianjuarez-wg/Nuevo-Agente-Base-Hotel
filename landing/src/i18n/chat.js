...
const STRINGS = {
  es: {
    ...
    seeAvailability: 'Ver disponibilidad y precios',
    seeAvailabilityMsg: (room) => `Quiero ver disponibilidad de la habitación ${room}.`,
    upTo: 'Hasta',
    total: 'Total',
    stay: 'estadía',
  ...
  en: {
    ...
    seeAvailability: 'See availability & prices',
    seeAvailabilityMsg: (room) => `I'd like to see availability for the ${room} room.`,
    upTo: 'Up to',
    total: 'Total',
    stay: 'stay',
  ...
  pt: {
    ...
    seeAvailability: 'Ver disponibilidade e preços',
    seeAvailabilityMsg: (room) => `Quero ver disponibilidade do quarto ${room}.`,
    upTo: 'Até',
    total: 'Total',
    stay: 'estadia',
    promoApplied: 'Promo aplicada',
  ...
  fr: {
    ...
    seeAvailability: 'Voir disponibilités et prix',
    seeAvailabilityMsg: (room) => `Je voudrais voir les disponibilités de la chambre ${room}.`,
    upTo: "Jusqu'à",
    total: 'Total',
    stay: 'séjour',
