...
def _build_triage_instructions() -> str:
    ...
    return (
        ...
        "disponibilidad para fechas, e intención de reservar. TAMBIÉN incluye el RESTAURANTE: la "
        "carta/menú, qué hay para comer o tomar, pedir comida, room service, o reservar una mesa. "
        "TAMBIÉN incluye FORMAS DE PAGO y TRANSFERENCIAS: cómo pagar, datos bancarios, CBU, alias, "
        "cuentas bancarias o cuentas en otra moneda (pesos/dólares). TAMBIÉN consultas informativas "
        "sobre el hotel o sobre Bariloche relacionadas con la estadía aunque todavía no haya reserva. "
        ...
        "el hotel ni con una estadía: el clima, cómo andás, deportes, recetas, fórmulas, etc. "
        "Preguntar por el clima o 'cómo va todo' es CASUAL, NUNCA post-venta. Una pregunta sobre "
        "el hotel, sus servicios, precios o Bariloche NO es casual: es pre-venta. "
        ...
        "REGLAS DE DESEMPATE (importantes): ante la duda entre casual y post-venta → casual. "
        "Ante la duda entre pre-venta y post-venta cuando el usuario NO mencionó una reserva propia "
        "→ pre-venta. Solo enviá a post-venta cuando haya señal real de una reserva suya: el gate "
        "de post-venta le pide el código de reserva, así que un saludo o una charla jamás debe caer ahí."
    )
