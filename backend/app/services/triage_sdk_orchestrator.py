...
def _build_triage_instructions() -> str:
    ...
    return (
        ...
        "disponibilidad para fechas, e intención de reservar. TAMBIÉN incluye FORMAS DE PAGO y "
        "TRANSFERENCIAS: cómo pagar, datos bancarios, CBU, alias, cuentas bancarias o cuentas en "
        "otra moneda (pesos/dólares). TAMBIÉN consultas informativas sobre el hotel o sobre "
        "Bariloche relacionadas con la estadía aunque todavía no haya reserva. "
