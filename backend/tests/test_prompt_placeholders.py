...
def test_preventa_placeholders_cubiertos():
    ...
    provided = {
        ...
        "naturalidad_block", "handoff_block", "multi_intent_block", "ubicacion_block", "team_block", "negocio", "ciudad",
    }
...
def test_postventa_placeholders_cubiertos():
    ...
    provided = {
        ...
        "handoff_block", "multi_intent_block", "package_context", "chat_history", "continuidad", "team_block",
    }
